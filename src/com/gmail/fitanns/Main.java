...
public class Main {
	...
	public static void main(String[] args) {
		...
		Student fifthStudent = new Student(19, "ukrainian", "white", 175, 54, "female", "Olesya", "Virchenko");
		Student sixthStudent = new Student(18, "ukrainian", "white", 184, 90, "male", "Eugene", "Dybina");
